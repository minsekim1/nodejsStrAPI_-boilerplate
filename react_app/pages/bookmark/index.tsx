...
import localStorageEffect from "../../hook/recoil/localStorageEffect";
...
const Bookmark = () => {
  return (
    <>
      ...
      <CountButton2 />
      <br />
      *CountButton 는 페이지 이동시 값이 초기화 되지만 useState가 아닌 useRecoilState를 사용할 경우 전역 State로
      관리되기떄문에 앱이 종료되기 전까지 유지됩니다.
      <br />
      <br />
