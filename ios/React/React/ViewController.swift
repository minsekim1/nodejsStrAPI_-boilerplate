...
//       let request: URLRequest = URLRequest.init(url: NSURL.init(string: "http://172.30.1.8:3000")! as URL, cachePolicy: URLRequest.CachePolicy.useProtocolCachePolicy, timeoutInterval: 10)
         let request: URLRequest = URLRequest.init(url: NSURL.init(string: "https://dongwon.circlin.co.kr:444/")! as URL, cachePolicy: URLRequest.CachePolicy.useProtocolCachePolicy, timeoutInterval: 10)
